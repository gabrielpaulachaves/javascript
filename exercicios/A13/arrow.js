...
/*arrow function é uma forma curta de escrever uma function expression. E quando a função possui apenas uma instrução (a instrução de retorno), vc não precisa de return */
